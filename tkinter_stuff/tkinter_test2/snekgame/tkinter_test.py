...
class Snake(Canvas):
    ...
    def __init__(self):
        super().__init__(width=600, height=620, bg="black",
                         highlightthickness=0)

        self.snake_position = [(100, 100), (80, 100), (60, 100), (40, 100)]
    ...
    def create_objects(self):
        self.create_text(45, 12, text=f"Score {self.score}", tag="score",
    ...
    def move_snake(self):
        ...
        if self.direction == "Left":
            ...
            print("Left:", new_head_position)
        elif self.direction == "Right":
            new_head_position = (head_x_position + MOVE_INCREMENT, head_y_position)
            print("Right:", new_head_position)
        elif self.direction == "Down":
            new_head_position = (head_x_position, head_y_position + MOVE_INCREMENT)
            print("Down:", new_head_position)
        elif self.direction == "Up":
            new_head_position = (head_x_position, head_y_position - MOVE_INCREMENT)
            print("Up:", new_head_position)
    ...
    def end_game(self):
        ...
        self.create_text(
            self.winfo_width() / 2,
            self.winfo_height() / 2,
            text=f"Game over dumbass! You scored {self.score}!",
            fill="#fff",
